...
#define TS_SW_47_REPLACE               BIT(26)
#define TS_DMX_INF_SET               (TS_SW_BIT_SEL_CDATA0 | TS_SERIAL_IN | TS_SW_ERR_BYPASS | TS_SW_SERIAL_SYNCBIT_MODE | TS_SW_SYNC_MODE |TS_SW_47_REPLACE)
