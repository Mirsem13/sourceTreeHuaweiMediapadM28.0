...
struct max98925_reg_ops{
    unsigned int reg_addr;
    unsigned int reg_val;
};

/*IO controls for user*/
#define M98925_POWER_ON					_IO('M', 0x01)
...
#define M98925_GET_DAIFORMAT			_IOR('M', 0x11, __u32)
#define M98925_GET_DAICLOCK				_IOR('M', 0x12, __u32)
#define M98925_GET_BOOSTVOLT			_IOR('M', 0x13, __u32)
#define M98925_GET_ALCTHRESHOLD			_IOR('M', 0x14, __u32)
...
#define M98925_SET_DAIFORMAT			_IOW('M', 0x41, __u32)
#define M98925_SET_DAICLOCK				_IOW('M', 0x42, __u32)
#define M98925_SET_BOOSTVOLT			_IOW('M', 0x43, __u32)
#define M98925_SET_ALCTHRESHOLD			_IOW('M', 0x44, __u32)
#define M98925_SET_FILTERS				_IOW('M', 0x45, __u32)
#define M98925_SET_GAINRAMP				_IOW('M', 0x46, __u32)
#define M98925_SET_REG_VAL				_IOW('M', 0x47, struct max98925_reg_ops)
