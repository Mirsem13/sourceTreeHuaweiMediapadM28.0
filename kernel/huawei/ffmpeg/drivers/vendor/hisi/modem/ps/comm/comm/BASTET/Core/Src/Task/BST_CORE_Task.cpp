...
BST_VOID BST_CTask::SetRunMode ( BST_RUN_MODE_ENUM_UINT8 enRunMode )
{
    if ( BST_IsRunModeValid (enRunMode) )
    {
        m_enRunMode                     = enRunMode;
    }
}


BST_RUN_MODE_ENUM_UINT8 BST_CTask::GetRunMode ( BST_VOID )
{
    return m_enRunMode;
}
